...
support_locales = ["zh-CN", "zh-HK", "zh-TW", "de-DE", "en-US", "fr-FR", "vi-VN", "th-TH", "es-ES"]
...
with middle_panel:
    with st.container(border=True):
        ...
        params.video_clip_duration = st.selectbox(tr("Clip Duration"), options=[2, 3, 4, 5, 30, 60, 90, 180, 300, 500], index=1)
